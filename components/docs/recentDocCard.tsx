...
const RecentDocCard = ({ doc }: Props) => {
  ...
  return (
    <div className="mx-auto w-full">
      <div className="rounded-lg dark:bg-gray-900 text-black dark:text-white border border-1 border-gray-500 hover:border-green-400 min-h-[300px] md:min-h-[500px] md:max-h-[500px]">
