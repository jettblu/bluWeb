...
const BlogFeature = ({ doc }: Props) => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="max-w-3xl rounded-lg dark:bg-gray-900 text-black dark:text-white py-6 px-4 border border-1 border-slate-400 dark:border-slate-700 hover:border-2 hover:border-green-400">
